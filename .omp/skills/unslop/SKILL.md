---
name: unslop
description: Cut AI tells from any writing — strip AI vocabulary, em-dash/colon/boldface overuse, significance inflation, sycophancy, filler, hedging, and passive voice, then add human voice. Use when cleaning up or humanizing prose, unslopping text, removing AI-generated writing patterns, or tightening a draft.
license: MIT
---

<!-- Vendored from poteto's `pstack` (`/unslop` skill), via the Claude Code port
     michael-denyer/pstack-claude (plugins/pstack/skills/unslop). MIT licensed.
     Author: poteto (https://no.lol). Body kept faithful to upstream; only the
     frontmatter `description` was expanded so oh-my-pi skill discovery can match it. -->
